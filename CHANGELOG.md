...
All notable changes to **@core2ai/core** are documented here.
...
- **`@core2ai/core` codegen package** (`./codegen` export): shared templates for MCP tool modules and four host binaries per project
...
- Consumer repos (api2ai, db2ai) pin `@core2ai/core`; after upgrading core2ai, sync the pin and run `generate:all` + `build:generated` in each project workspace
