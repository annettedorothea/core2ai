...
export function renderCompileGeneratedFixtureSource(): string {
    const body = [
        ...
        '            if (',
        '                demosCandidate &&',
        '                (resolvedStart === demosCandidate.root ||',
        '                    resolvedStart.startsWith(`${demosCandidate.root}${path.sep}`))',
        '            ) {',
        ...
        '    const tsInclude = isDemosTmpFixture',
        '        ? [...include, ...syncDemosModuleShims(projectRoot, workspace)]',
        '        : include;',
