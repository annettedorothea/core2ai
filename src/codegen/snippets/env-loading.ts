/** Product-neutral env file loading for generated MCP hosts. */
export function localEnvFilesConstSnippet(): string {
    return `const LOCAL_ENV_FILES = ['.env', '.env.local'];`;
}

export function envLoadingFunctionsSnippet(): string {
    return `
