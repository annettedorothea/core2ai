...
/**
 * start-service-lib: workspace-anchored helpers.
 * prepareWorkspaceEnv imports hand `scripts/copy-env.mjs` + sibling load-env-local.
 */
export function renderStartServiceLibMjsSource(): string {
    const lines = [
